...
const MEMBER_COLORS: Record<string, { bar: string; bg: string; text: string }> = {
  '조현석': { bar: '#7C3AED', bg: 'bg-purple-100', text: 'text-purple-700' },
  '조정연': { bar: '#059669', bg: 'bg-green-100',  text: 'text-green-700'  },
  '이헌희': { bar: '#D97706', bg: 'bg-amber-100',  text: 'text-amber-700'  },
  '이지은': { bar: '#EA580C', bg: 'bg-orange-100', text: 'text-orange-700' },
}
