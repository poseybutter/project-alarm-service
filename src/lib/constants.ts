...
export const MEMBER_COLORS: Record<string, { bg: string; text: string; bar: string; border: string }> = {
  '조현석': { bg: 'bg-purple-100', text: 'text-purple-700', bar: '#7C3AED', border: 'border-purple-400' },
  '조정연': { bg: 'bg-green-100',  text: 'text-green-700',  bar: '#059669', border: 'border-green-400'  },
  '이헌희': { bg: 'bg-amber-100',  text: 'text-amber-700',  bar: '#D97706', border: 'border-amber-400'  },
  '이지은': { bg: 'bg-orange-100', text: 'text-orange-700', bar: '#EA580C', border: 'border-orange-400' },
}
